...
<body>
    ...
    <section class="contenedor induccion">
        ...
        <div class="botones">
            <a href="ActividadPrevia" class="btn-main">Volver a la Actividad previa</a>
            <a href="Estrategias_Prueba_Software" class="btn-main">Continuar a la Estrategia de Prueba de Software</a>
        </div>
